...
public class BookSettingController
{
	...
	public void initialize()
	{
		...
		{
			case BEST_SCORE:
				bestScoreRadioButton.setSelected(true);
				break;
			case BEST_WINRATE:
				bestWinrateRadioButton.setSelected(true);
				break;
			case POSITIVE_RANDOM:
				positiveRandomRadioButton.setSelected(true);
				break;
			case FULL_RANDOM:
				fullRandomRadioButton.setSelected(true);
				break;
			default:
				break;
		}
