...
public class HttpUtils
{
	 ...
	 * @throws IOException
	 */
	public static String sendByPost(String url, String json, Map<String, String> header, String contentType)
			throws IOException
	{
		...
		try
		{
			...
			reader = new BufferedReader(new InputStreamReader(
					con.getResponseCode() == HttpURLConnection.HTTP_OK ? con.getInputStream() : con.getErrorStream(),
